...
import PublicArticleDetailsContent from "./PublicArticleDetailsContent";
const PublicArticleDetailsChapter = ({
  hirarcyData,
  item,
...
export default PublicArticleDetailsChapter;
