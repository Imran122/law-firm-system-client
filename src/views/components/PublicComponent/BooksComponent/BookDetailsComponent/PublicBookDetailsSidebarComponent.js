...
import PublicBookDetailsChapter from "./PublicBookDetailsChapter";

const PublicBookDetailsSidebarComponent = ({ setBookItemContent }) => {
...
export default PublicBookDetailsSidebarComponent;
