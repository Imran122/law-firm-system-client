...
import PublicInsightDetailsChapter from "./PublicInsightDetailsChapter";
const PublicInsightDetailsSidebarComponent = ({ setArticleItemContent }) => {
...
export default PublicInsightDetailsSidebarComponent;
