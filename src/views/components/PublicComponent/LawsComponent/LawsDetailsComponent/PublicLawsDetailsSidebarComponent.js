...
import PublicLawsDetailsChapter from "./PublicLawsDetailsChapter";
const PublicLawsDetailsSidebarComponent = ({ setArticleItemContent }) => {
...
export default PublicLawsDetailsSidebarComponent;
