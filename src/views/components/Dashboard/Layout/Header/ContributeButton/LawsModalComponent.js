...
const LawsModalComponent = ({ setContributeLaws }) => {
  const allRegionName = [
  ...
  const [uploadDataForLaws, setUploadDataForLaws] = useState([]);
...
export default LawsModalComponent;
