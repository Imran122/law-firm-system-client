...
const BooksModalComponent = ({ setContributeBook }) => {
  ...
  const [uploadDataForBook, setUploadDataForBook] = useState([]);
...
export default BooksModalComponent;
