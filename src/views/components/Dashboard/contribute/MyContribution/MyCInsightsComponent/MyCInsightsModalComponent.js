...
const MyCInsightsModalComponent = ({ setInsights, contributeEdit }) => {
  ...
  const [uploadDataInsight, setUploadDataInsight] = useState(contributeEdit);
  console.log('uploadDataInsightuploadDataInsight',uploadDataInsight)
  ...
  const submitInsightUpload = (e) => {
    ...
    fetch(`${process.env.REACT_APP_API}/api/book-contribute-update`, {
      ...
      body: JSON.stringify(uploadDataInsight),
    })
        ...
        <form onSubmit={submitInsightUpload}>
          ...
          <div className="mb-3">
            ...
            <Select
              ...
              styles={customStyles}
              defaultValue={{ label: uploadDataInsight.regionNameList, value: uploadDataInsight.regionNameList }}
              required
            />
          </div>
          <div className="mb-3">
            ...
            <Select
              ...
              onChange={handleCountryType}
              styles={customStyles}
              defaultValue={{ label: uploadDataInsight.countryNameList, value: uploadDataInsight.countryNameList }}
              required
            />
          </div>
          <div className="mb-3">
            ...
            <Select
              ...
              styles={customStyles}
              defaultValue={{ label: uploadDataInsight.insightCategorey, value: uploadDataInsight.insightCategorey }}
              required
              id="subject"
            />
          </div>
          <div className="mb-3">
            ...
            <input
              ...
              onChange={handleOnType}
              className="form-control lm-border"
              value={uploadDataInsight?.reviewDate}
            />
          </div>
          <div className="mb-3">
            ...
            <textarea
              ...
              value={uploadDataInsight?.insightOverview}
...
export default MyCInsightsModalComponent;
