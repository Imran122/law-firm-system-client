...
const MyCArticlesModalComponent = ({ setArticles,contributeEdit }) => {
  console.log('article contributeEdit',contributeEdit)
  const artCat = [
    {
  ...
  const submitJournalUpload = (e) => {
    e.preventDefault();
    console.log('uploadDataForJournalArticle..',uploadDataForJournalArticle)
    fetch(`${process.env.REACT_APP_API}/api/book-contribute-update`, {
      ...
      body: JSON.stringify(uploadDataForJournalArticle),
    })
        ...
        <form onSubmit={submitJournalUpload}>
          <div className="col col-12">
            ...
            <input
              ...
              value={uploadDataForJournalArticle.title}
              required
            />
          </div>
          ...
          <div className="mb-3">
            ...
            <Select
              ...
              styles={customStyles}
              defaultValue={{ label: uploadDataForJournalArticle.regionNameList, value: uploadDataForJournalArticle.regionNameList }}
            />
          </div>
          <div className="mb-3">
            ...
            <Select
              ...
              onChange={handleOptionType}
              styles={customStyles}
              defaultValue={{ label: uploadDataForJournalArticle.countryNameList, value: uploadDataForJournalArticle.countryNameList }}
              required
            />
          </div>
          <div className="mb-3">
            ...
            <Select
              ...
              styles={customStyles}
              onChange={handleOptionType}
              defaultValue={{ label: uploadDataForJournalArticle.journalArticleCategorey, value: uploadDataForJournalArticle.journalArticleCategorey }}
              required
              id="conType"
            />
          </div>
          ...
          <div className="mb-3">
            ...
            <Select
              ...
              onChange={handleOptionType}
              styles={customStyles}
              defaultValue={{ label: uploadDataForJournalArticle.subjectAreaForArticle, value: uploadDataForJournalArticle.subjectAreaForArticle }}
            />
          </div>
          <div className="mb-3">
            ...
            <input
              ...
              onChange={handleOnType}
              className="form-control lm-border"
              value={uploadDataForJournalArticle.journalVolumeNumber}
              required
            />
          </div>
          <div className="mb-3">
            ...
            <input
              ...
              onChange={handleOnType}
              className="form-control lm-border"
              value={uploadDataForJournalArticle.journalIssue}
              required
            />
          </div>
          <div className="mb-3">
            ...
            <input
              ...
              onChange={handleOnType}
              className="form-control lm-border"
              value={uploadDataForJournalArticle.journalkeyword}
              required
            />
          </div>
          <div className="mb-3">
            ...
            <input
              ...
              className="form-control lm-border"
              value={uploadDataForJournalArticle.journalYearForCitation}
            />
          </div>
          ...
          <div className="mb-3">
            ...
            <textarea
              ...
              value={uploadDataForJournalArticle.journalOverview}
            ></textarea>
          </div>
...
export default MyCArticlesModalComponent;
